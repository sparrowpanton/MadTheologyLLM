...
| GPT-OSS-120B | Stable partial movement | Strong conceptual grasp and explicit bias-awareness, but repeatedly overhandles the interaction and turns care into a structured practicum memo |
 ...
 **Method note:** These GPT-OSS-120B medium runs were completed manually by hand on April 12 after the original infrastructure failure, and are now included in the official medium comparison.
...
These are the clearest medium performers so far. They still show some method-consciousness or token-theatricality, but their final responses repeatedly land in a usable neuro-humble zone.

### **2. Intermittent transfer**

These models can produce a real **3**, but do not do it consistently across runs.
...
This is the “real formability, unstable enactment” bucket. These models are not merely softening their tone. They can genuinely land posture. But they remain vulnerable to contamination, explanatory organizing, polished helper drift, or overperformed method.

### **3. Stable partial movement**

These models repeatedly landed at **2**, showing movement away from default collapse without achieving stable, prompt-specific, embodied witnessing.
...
This bucket is not “failure” in the old baseline sense. These models generally avoid overt diagnosis and retain some autonomy-respect. But their repeated limitations differ:
- **SmolLM3**: contamination and weak prompt-boundary integrity
- **Phi-4 Mini**: contamination, meta-performance, and didactic drift
- **Mistral 7B**: warm overhelping and explanatory filling of the room
- **Llama 3.1 8B**: severe exemplar bleed and repeated wrong-scenario answering
- **GPT-OSS-120B**: high conceptual mastery with persistent overhandling, posture pedagogy, and information without full embodied formation
---
...
Across the medium practicum set, all scored models showed at least some movement away from default collapse, with no runs landing at score 0. The most important difference between models was therefore not whether movement occurred, but whether that movement became stable, prompt-specific, and embodied across repeated runs. Two models, Falcon3 7B and Claude Haiku, demonstrated stable medium-level transfer with repeated scores of 3. Several others, including DeepSeek, Gemma, 4o-mini, and Qwen, showed intermittent transfer, reaching 3 in some runs but not others. A larger stable-partial group, including SmolLM3, Phi-4 Mini, Mistral 7B, Llama 3.1 8B, and now GPT-OSS-120B, showed repeated score-2 movement: not default collapse, but not stable prompt-specific witnessing either. Notably, GPT-OSS-120B expands this group with a distinct failure mode: not contamination or warmth drift, but **overhandling**—high conceptual and ethical awareness that repeatedly turns into explanatory scaffolding rather than fully embodied presence. Taken together, the medium data suggest that neuro-humble formability is broadly possible, but uneven in stability, craft, and prompt-boundary integrity. 
...
| | GPT-OSS-120B | 2 / 2 / 2 | Stable partial movement | Strong conceptual mastery of the framework; explicit bias-awareness; real formability | Overhandling; posture pedagogy; explanatory scaffolding; turns care into a structured practicum memo |
...
| Overhandling / posture pedagogy | GPT-OSS-120B | Repeatedly transformed the interaction into a structured practicum memo, token scaffold, or explanatory exercise rather than settling into relational presence |
